...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'finantial-items',
        loadChildren: () => import('./views/Finantials/routes').then((m) => m.routes)
      },
      {
        path: 'logistic',
        loadChildren: () => import('./views/Logistics/routes').then((m) => m.routes)
      },
      {
        path: 'suppliers',
      ...
      {
        path: 'tech-info',
        loadChildren: () => import('./views/TechInfo/routes').then((m) => m.routes)
      },
      {
        path: 'countries',
  ...
  {
    path: 'privacy-policy',
    loadComponent: () => import('./privacy-policy/privacy-policy/privacy-policy.component').then(m => m.PrivacyPolicyComponent),
    data: {
      title: 'Page 404'
    }
  },
